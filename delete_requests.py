...
def delete_fertilizer(access_token, id, ranchGuid):
    url = f"https://api.cropmanage.ucanr.edu/v2/ranches/{ranchGuid}/fertilizers/{id}." + "{ext}"
...
def delete_irrigation_event(access_token, id):
    url = f"https://api.cropmanage.ucanr.edu/v2/irrigation-events/{id}." + "{ext}"
...
def delete_planting(access_token, plantingId):
    url = f"https://api.cropmanage.ucanr.edu/v2/plantings/{plantingId}." + "{ext}"
...
def delete_ranch(access_token, ranchGuid):
    url = f"https://api.cropmanage.ucanr.edu/v2/ranches/{ranchGuid}.json"
...
def delete_ranch_user(access_token, ranchGuid, userIdTarget):
    url = f"https://api.cropmanage.ucanr.edu/v2/ranches/{ranchGuid}/users/{userIdTarget}.json"
...
def delete_weather_station(access_token, stationId, ranchGuid):
    url = f"https://api.cropmanage.ucanr.edu/v2/ranches/{ranchGuid}/weather-stations/{stationId}." + "{ext}"
